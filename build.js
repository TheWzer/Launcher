...
class Index {
    ...
    async buildPlatform() {
        ...
        builder.build({
            config: {
                ...
                linux: {
                    icon: "./app/assets/images/icon_launcher.png",
                    target: [{
                        target: "AppImage",
                        arch: "x64"
                    }]
    ...
    async iconSet(url) {
        ...
        if (Buffer.status == 200) {
            ...
            fs.writeFileSync("src/assets/images/icon_launcher.ico", png2icons.createICO(Buffer, png2icons.HERMITE, 0, false));
            fs.writeFileSync("src/assets/images/icon_launcher.png", Buffer);
